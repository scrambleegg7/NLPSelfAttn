...
class Attention(nn.Module):
    def __init__(self, query_dim, key_dim=100, value_dim=100):
...
class AttentionClassifier(nn.Module):
    def __init__(self, h_dim, c_num):
        ...
        self.decoder = nn.Linear(h_dim, c_num)
        
    def forward(self, encoder_outputs, hidden):
        energy, linear_combination = self.attn( hidden, encoder_outputs, encoder_outputs) #(b, s, 1)
